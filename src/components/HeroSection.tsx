    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl text-muted-foreground max-w-3xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            Frontend Developer & Full Stack Engineer
          </p>

          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
          ...
          {/* Social Links */}
          <div className="flex justify-center space-x-6 animate-fadeInUp" style={{ animationDelay: '1s' }}>
            <a 
              href="#" 
        ...
        >
          <ChevronDown size={32} className="text-muted-foreground hover:text-purple transition-colors duration-300" />
        </button>
      </div>
    </section>
  );
