...
import { Code, Palette, Zap, CircleCheck } from "lucide-react";
  ...
  const highlights = [
    {
      ...
      title: "Clean Code",
      description:
        "Writing maintainable, scalable code with best practices and modern standards.",
    },
    {
      icon: Palette,
      title: "Creative Design",
      description:
        "Transforming ideas into beautiful, intuitive user interfaces that users love.",
    },
    {
      icon: Zap,
      title: "Performance",
    ...
    },
    {
      ...
      description:
        "Approach challenges with creativity and logic, delivering efficient solutions under pressure.",
    },
  ];
          ...
          <div className="space-y-6">
            <div className="about-card opacity-0">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                With over 1+ years of experience in frontend development, I
                specialize in creating responsive, accessible, and performant
                web applications. My journey started with a curiosity about how
              ...
              <p className="text-lg text-muted-foreground mb-4">
                ...
                problems. Whether it's building a complex dashboard, optimizing
                performance, or creating intuitive user interfaces, I approach
              ...
              <p className="text-lg text-muted-foreground">
                ...
                tools, and creating side projects
              </p>
            </div>
          </div>
